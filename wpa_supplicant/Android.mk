...
ifneq ($(BOARD_WPA_SUPPLICANT_PRIVATE_LIB), lib_driver_cmd_rtl)
$(error "BOARD_WPA_SUPPLICANT_PRIVATE_LIB is "$(BOARD_WPA_SUPPLICANT_PRIVATE_LIB)" not lib_driver_cmd_rtl")
endif
else
$(error "BOARD_WIFI_VENDOR is "$(BOARD_WIFI_VENDOR)" not realtek")
endif
